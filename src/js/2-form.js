...
inputFill.elements.email.value = JSON.parse(localStorage.getItem(localStorageKey) ?? "");
inputFill.elements.message.value = JSON.parse(localStorage.getItem(localStorageKey) ?? "");
